        ...
        {editing && (
          <div className="w-full border border-gray-200 rounded-xl p-6 shadow-sm bg-white">
            ...
            <button
              ...
              className="mt-5 bg-green-600 text-white font-semibold rounded-xl px-5 py-2.5
                transition-all duration-200 hover:bg-green-700 hover:-translate-y-0.5
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="bg-green-600 text-white font-semibold px-6 py-3 rounded-xl
              shadow-sm transition-all duration-200 hover:bg-green-700
